...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        if username == tl_admin_user or user_info :  # validate user
            ...
            mensaje = "❌No tienes Acceso❌.\nPor favor contacte a @JOSE_752 si quieres utilizar este servicio\n"
            intento_msg = "💢El usuario @"+username+ " ha intentando usar el bot sin permiso💢"
            bot.sendMessage(update.message.chat.id,mensaje)
            bot.sendMessage(1629194610,intento_msg)
            return
        ...
        if '/tutorial' in msgText:
            ...
            tuto.close()
            return
        if "/configuraciones" in msgText:
            msg ="☁Aqui te dejo las configuraciones de algunas nubes☁\n🔆Solo debes tocar el comando de la nube que desea configurar y listo se pone automáticamente la configuración de esa nube🔆"
            bot.sendMessage(update.message.chat.id,msg)
            return
        ...
        if '/start' in msgText:
            start_msg = '🤖Bot: Alquiler01\n'
            start_msg+= '🎩Dueño: @JOSE_752\n'
            start_msg+= '🔥Recomendacion: Si quieres descargar peliculas,series,etc unete a este grupo 👉 https://t.me/+f40-ypG44s1lZDUy\n⭕En el tu pides lo que quieras ver y el dueño del grupo se lo sube para que lo pueda descargar\n'
            start_msg+= '😉Uso del Bot: Envia Enlaces De Descarga Para Procesar (Configure Antes De Empezar)\n'
            ...
            #    bot_token = '5855943574:AAHysayg0p5OD8N9qHwrB3ld3C0x9KnY1-8'
